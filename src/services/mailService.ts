...
const browserService = {
  ...
  saveTag: async (_tag: Tag | Omit<Tag, "id">): Promise<Tag> => ({ id: 0, name: "", color: "" }),
  deleteTag: async (_id: number) => undefined,
  setEmailTags: async (_emailId: number, _tagIds: number[]) => undefined,
  setEmailsTags: async (_emailIds: number[], _tagIds: number[]) => undefined,
  ...
  exportBackupToFile: async (_path: string, _password: string) => undefined,
  importBackupFromFile: async (_path: string, _password?: string) => undefined,
...
const electronService = {
  ...
  saveTag: (tag: Tag | Omit<Tag, "id">) => invokeDesktop<Tag>("save_tag", { tag }),
  ...
  setEmailsTags: (emailIds: number[], tagIds: number[]) => invokeDesktop<void>("set_emails_tags", { emailIds, tagIds }),
  ...
  exportBackupToFile: (path: string, password: string) => invokeDesktop<void>("export_backup_to_file", { path, password }),
  importBackupFromFile: (path: string, password?: string) => invokeDesktop<void>("import_backup_from_file", { path, password }),
